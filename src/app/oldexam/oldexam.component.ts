  ...
  if (distance < 0) {
    ...
    hello.resultcal();
     ...
     else
     {
          ...
          this.createform();
this.paperber = JSON.parse(localStorage.getItem('paperber'+localStorage.getItem("epid2")+localStorage.getItem("user213")) || 'false');
this.numblimit = JSON.parse(localStorage.getItem('numblimit'+localStorage.getItem("epid2")+localStorage.getItem("user213")) || '0');
if(this.paperber == false)
{
  //console.log(this.paperber);
  setTimeout(()=>{
        this.auth.getpap(localStorage.getItem("epid2"),localStorage.getItem("user213")).subscribe(data123 => {
      if(data123!='')
      {
